...
<html>
<head>
	<title>SIP | Cek Tagihan Santri</title>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title><?php echo $this->config->item('app_name') ?> <?php echo isset($title) ? ' | ' . $title : null; ?></title>
	<link rel="icon" type="image/png" href="<?php echo media_url('img/logotk.jpg') ?>">
...
<body>
	<nav class="navbar navbar-default fixed">
		<div class="navbar-header"> 
			<a class="navbar-brand" href=""> ADMINISTRASI 
				...
				<?php } else { ?>
				<img src="<?php echo media_url('img/logotk.jpg') ?>" style="height: 40px; margin-top: -10px; margin-right: 5px;" class="pull-left">
