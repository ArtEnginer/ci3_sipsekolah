...
<head>
  ...
  <title>TK Aisyiyah Bustanul Atfal | Login</title>
  ...
  <div class="row">
    <div class="col-md-5">
      <div class="logo hidden-xs hidden-sm">
        ...
        <img src="<?php echo media_url('img/logotk.jpg') ?>" class="img-responsive">
        <?php } else { ?>
        <img src="<?php echo upload_url('school/' . $setting_logo['setting_value']) ?>" class="img-responsive">
        <?php } ?>
      </div>
      <p class="merk"><span style="color: #2ABB9B">SIP</span>Schools</p> 
